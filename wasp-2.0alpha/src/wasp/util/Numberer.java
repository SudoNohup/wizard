...
public class Numberer {
    ...
    /**
     * Indicates if the specified object has been assigned an ID by this numberer.
     * 
     * @param o an object.
     * @return <code>true</code> if the specified object has been assigned an ID by this numberer;
     * <code>false</code> otherwise. 
     */
    public boolean containsObj(Object o) {
    	return getId(o, false) >= 0;
    }
