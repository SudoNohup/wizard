...
/**
 * A version of the n-gram NL language model that uses the CMU-Cambridge Statistical Language Modeling
 * Toolkit for training.  The toolkit can be found in <a
 * href="http://mi.eng.cam.ac.uk/~prc14/toolkit.html"
 * target="_new">http://mi.eng.cam.ac.uk/~prc14/toolkit.html</a>.  Learned models are written in the ARPA
 * format.
 * 
 ...
 *
 */
public class CMUCamNgramModel extends NgramModel {

	private static Logger logger = Logger.getLogger(CMUCamNgramModel.class.getName());
	...
	public CMUCamNgramModel() throws IOException {
	...
	public void train(Examples examples) throws IOException {
		...
		args[6] = "-arpa";
		args[7] = new File(Config.getModelDir(), NGRAM_MODEL).getPath();
		args[8] = "-good_turing";
		args[9] = "-disc_ranges";
