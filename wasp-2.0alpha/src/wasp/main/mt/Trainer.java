...
/**
 * The command-line interface to the trainer of machine translators.
 * 
 * @author ywwong
 *
 */
public class Trainer {
	...
	/**
	 * The main program for training MT models.  This program takes the following command-line
	 * arguments:
	 * <p>
	 * <blockquote><code><b>java wasp.main.mt.Trainer</b> <u>config-file</u> <u>model-dir</u>
	 * <u>mask-file</u></code></blockquote>
	 * <p>
	 * <ul>
	 * <li><code><u>config-file</u></code> - the configuration file that contains the current 
	 * settings.</li>
	 * <li><code><u>model-dir</u></code> - the directory for storing the learned MT model.</li>
	...
	public static void main(String[] args) throws IOException, SAXException, ParserConfigurationException {
		if (args.length != 3) {
			System.err.println("Usage: java wasp.main.mt.Trainer config-file model-dir mask-file");
			System.err.println();
			System.err.println("config-file - the configuration file that contains the current settings.");
			System.err.println("model-dir - the directory for storing the learned MT model.");
		...
		MTModel.createNew().train(examples);
	}
