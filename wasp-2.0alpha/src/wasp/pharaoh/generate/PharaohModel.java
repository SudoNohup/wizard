...
/**
 * A tactical generation model based on Pharaoh.  This class also implements the Pharaoh++ variant
 * of the model, which uses linearized MR parse-trees as the input to the tactical generator.
 * 
 * @author ywwong
 *
 */
public class PharaohModel extends GenerateModel {

	private PhraseTranslationModel tm;
	private NgramModel lm;
	
	/**
	 * Constructs a new NL generation model based on Pharaoh.
	 * 
	...
	public Generator getGenerator() throws IOException {
		return new PharaohGenerator(tm);
	}
