...
/**
 * The n-gram MRL language model trained using the CMU-Cambridge Statistical Language Modeling Toolkit.
 ...
 *
 */
public class CMUCamBinaryModel extends MRLModel {
	...
	/**
	 * Constructs a new n-gram language model for the target MRL.
	 * 
	 * @param vocab a mapping between MRL productions and their string representations.
	 * @throws IOException if an I/O error occurs.
	 */
	public CMUCamBinaryModel(MRLVocabulary vocab) throws IOException {
		super(vocab);
